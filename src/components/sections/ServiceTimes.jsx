    ...
    <SectionWrapper id="services" className="bg-cream-dark">
      ...
      <div className="mt-16 grid gap-8 lg:grid-cols-2 items-center">
        ...
        <div className="overflow-hidden rounded-2xl shadow-lg">
          <iframe
            title="GRC Location"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2797.5!2d-73.637!3d45.495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDXCsDI5JzQyLjAiTiA3M8KwMzgnMTMuMiJX!5e0!3m2!1sen!2sca!4v1"
            width="100%"
            height="300"
            style={{ border: 0 }}
            allowFullScreen=""
